...
void ui_event_Inclinometer(lv_event_t * e)
{
    ...
    if(event_code == LV_EVENT_GESTURE &&  lv_indev_get_gesture_dir(lv_indev_get_act()) == LV_DIR_RIGHT) {
        ...
        _ui_screen_change(&ui_InclinometerGraph, LV_SCR_LOAD_ANIM_NONE, 50, 0, &ui_InclinometerGraph_screen_init);
    }
    if(event_code == LV_EVENT_GESTURE &&  lv_indev_get_gesture_dir(lv_indev_get_act()) == LV_DIR_LEFT) {
        lv_indev_wait_release(lv_indev_get_act());
        _ui_screen_change(&ui_InclinometerNew, LV_SCR_LOAD_ANIM_NONE, 500, 0, &ui_InclinometerNew_screen_init);
    }
...
void ui_Inclinometer_screen_init(void)
{
    ...
    lv_obj_set_style_bg_grad_color(ui_Pitch, lv_color_hex(0x868686), LV_PART_INDICATOR | LV_STATE_DEFAULT);
    ...
    lv_obj_set_x(ui_PitchText, 48);
    lv_obj_set_y(ui_PitchText, 178);
    ...
    lv_obj_set_x(ui_PitchName, -66);
    lv_obj_set_y(ui_PitchName, 179);
...
void ui_Inclinometer_screen_destroy(void)
{
    if(ui_Inclinometer) lv_obj_del(ui_Inclinometer);
